...
function clock(options) {
    ...
    var getTimes = function () {
        var d = new Date(),
            funcs = {
                greetings: translate[current].greets,
                hour: function () {
                ...
                greet: function () {
                    if (this.rawhour() < 12) return this.greetings[0];
                    else if (this.rawhour() < 17) return this.greetings[1];
                    else return this.greetings[2];
                    // if (this.rawhour() < 12) return 'Good morning';
                    // else if (this.rawhour() < 17) return 'Good afternoon';
...
var current = (window.navigator.language.length >= 2) ? window.navigator.language.split('-')[0] : 'en',
    ...
    translate = {
        ...
        pl: {
            greets: ["Dzień dobry", "Dzień dobry", "Dobry wieczór"],
